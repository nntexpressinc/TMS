...
const LoadForm = ({ loadData, drivers, handleChange, activeStep, showCustomerForm, handleToggleCustomerForm, isDetailsComplete, isCustomerBrokerComplete, isReadOnly = false, handleAddToLoad }) => {
  return (
